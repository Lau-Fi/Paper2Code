...
class Dastan:
    def __init__(self, R, C, NoOfPieces): #Constructor with 4 arguments. So in the future you can set the name again. Constructors set the default values of a new object
        self._Board = []
        self._Players = []
        ...
        while not GameOver:
            ...
            try:
                ...
                while Choice < 1 or Choice > max_choice:
                    Choice = int(input("Choose move option to use from queue (1 to " + str(max_choice) + ") or 9 to take the offer: "))
                    if Choice == 9:
            ...
            if MoveLegal:
                ...
                if wafr:
                    ...
                    self._CurrentPlayer.SetWafrAwarded(False)
                    wafr = False
                else:
    ...
    def __AwardWafr(self):
        wafrchance = random.randint(0, 100)
        return wafrchance < 25
...
class Player:
    ...
    def SetWafrAwarded(self, Wafr): #Set takes an argument apart from self
        self.__WafrAwarded = Wafr
...
# https://medium.com/@aarafat27/mastering-the-art-of-object-oriented-programming-in-python-df04c83cc15b
